...
urlpatterns = [
    ...
    path('home/delete/<int:user>/<int:pk>/', views.ProductsDeleteView.as_view()),
    ...
    path('products/delete/<int:user>/<int:pk>/', views.ProductsDeleteView.as_view()),
    ...
    path('clients/delete/<int:user>/<int:pk>/', views.ClientsDeleteView.as_view()),
    ...
    path('facturacion/delete/<int:user>/<int:pk>/', views.FacturacionDeleteView.as_view()),
